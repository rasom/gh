...
exports.fetch = function(repoUrl, headBranch) {
    var args = ['fetch', repoUrl, headBranch, '--no-tags']
...
exports.getCommitBody = function(branch, number) {
    var git,
        params = ['log']
    ...
    params.push('-' + number, '--first-parent', '--no-merges', '--pretty=%b')
...
exports.getLastCommitBody = function(branch) {
    return exports.getCommitBody(branch, 1)
}
